...
export function TeamSection({
  ...
  return (
    <section className="py-12 md:py-16 lg:py-20" aria-labelledby="team-heading">
      <Container>
              ...
              <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
                <div>
                  ...
                  <p className="mt-4 max-w-xl text-sm leading-7 text-white/70">
                    ...
                    senior-led and every launch plan specific to the home,
                    timing, and buyer profile in play.
                  </p>
                </div>

export const buttonStyles = {
  ...
  secondaryInverse:
    "inline-flex min-h-12 items-center justify-center rounded-full border border-[rgba(255,233,204,0.32)] bg-[rgba(255,255,255,0.05)] px-6 py-3 text-sm font-semibold uppercase tracking-[0.22em] !text-[#f6ecdf] shadow-[inset_0_1px_0_rgba(255,240,220,0.1)] transition-all duration-300 hover:-translate-y-1 hover:border-[#f1ddbf] hover:bg-[rgba(255,255,255,0.1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#f1ddbf] focus-visible:ring-offset-2 focus-visible:ring-offset-[#120d0a]",
} as const;

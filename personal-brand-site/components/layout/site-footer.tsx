...
export function SiteFooter() {
  return (
    <footer className="border-t border-ink/8 bg-white/45 py-12">
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-ink/62">{siteConfig.tagline}</p>
            </div>
          </div>

          <p className="mt-6 max-w-xl text-sm leading-7 text-ink/70">{siteConfig.shortBio}</p>
          <p className="mt-4 max-w-xl text-sm leading-7 text-ink/58">{projectNote}</p>
        </div>

        <div className="grid gap-8 sm:grid-cols-2">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-ink/55">Navigate</p>
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-ink/55">Connect</p>
            <ul className="mt-4 space-y-3 text-sm text-ink/72">
      ...
      <Container className="mt-10 border-t border-ink/8 pt-6 text-sm text-ink/56">

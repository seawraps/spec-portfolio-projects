...
export default function AboutPage() {
  return (
    <>
      <section className="bg-gradient-to-b from-sky-50 to-white py-16 md:py-20 lg:py-24">
        <Container>
        ...
        <Container>
          ...
          <ol className="mt-8 grid gap-6 md:grid-cols-3">
            {aboutTimeline.map((item) => (
              <li key={item.year} className="surface-card-muted p-6">
        ...
        <Container>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {leadershipTeam.map((member) => (
              <article key={member.name} className="surface-card-muted p-6">
                <h3 className="font-display text-xl font-semibold tracking-tight text-slate-900">
                  {member.name}
                </h3>
          ...
          <div className="mt-10 rounded-2xl border border-amber-200 bg-amber-50 p-6 text-sm leading-6 text-amber-900">
